...
URL="https://dl.getistio.io/public/tetrate/getistio/raw/files/istio-${DISTRIBUTION_IDENTIFIER}-${OSEXT}.tar.gz"
ARCH_URL="https://dl.getistio.io/public/tetrate/getistio/raw/files/istio-${DISTRIBUTION_IDENTIFIER}-${OSEXT}-${ISTIO_ARCH}.tar.gz"
