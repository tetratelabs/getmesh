...
URL="https://istio.tetratelabs.io/getmesh/files/istio-${DISTRIBUTION_IDENTIFIER}-${OSEXT}.tar.gz"
ARCH_URL="https://istio.tetratelabs.io/getmesh/files/istio-${DISTRIBUTION_IDENTIFIER}-${OSEXT}-${ISTIO_ARCH}.tar.gz"
